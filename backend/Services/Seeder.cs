...
public static class Seeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        // ── GRUPPER ──────────────────────────────────────────────
        var groupFamiljen = new Group { Name = "Familjen" };
        var groupHJ       = new Group { Name = "HJ" };
        await db.Groups.AddRangeAsync(groupFamiljen, groupHJ);
        ...
        var usersData = new[]
        {
            ...
            // HJ (Sebnastian är ny, Jonas/Tim/Kalle är nya)
            (name:"Sebnastian",pass:"Sebnastian2026!",admin:false),
            (name:"Jonas",     pass:"Jonas2026!",     admin:false),
            (name:"Tim",       pass:"Tim2026!",       admin:false),
            (name:"Kalle",     pass:"Kalle2026!",     admin:false),
        };
        ...
        User U(string n) => dbUsers.First(u => u.Username == n);

        var familjenMembers = new[] { "Martin","Martha","Linn","Sebbe","Maths","Anette" };
        var hjMembers       = new[] { "Martin","Sebnastian","Jonas","Tim","Kalle" };

        var userGroups = new List<UserGroup>();
        foreach (var name in familjenMembers)
            userGroups.Add(new UserGroup { UserId = U(name).Id, GroupId = groupFamiljen.Id });
        foreach (var name in hjMembers)
            userGroups.Add(new UserGroup { UserId = U(name).Id, GroupId = groupHJ.Id });

        await db.UserGroups.AddRangeAsync(userGroups);

        // ── SIDO-SVAR (ett per grupp, tomt från start) ────────────
        await db.SidoAnswers.AddRangeAsync(
            new SidoAnswer { GroupId = groupFamiljen.Id },
            new SidoAnswer { GroupId = groupHJ.Id }
        );

        await db.SaveChangesAsync();

        // ── TIPS – FAMILJEN ───────────────────────────────────────
        var familjenTips = new Dictionary<string, Dictionary<int,(int h,int a)>>
        {
            ["Martin"] = new() {
        ...
        // ── TIPS – HJ ─────────────────────────────────────────────
        var hjTips = new Dictionary<string, Dictionary<int,(int h,int a)>>
        {
            ["Sebnastian"] = new() {
                {1,(2,1)},{2,(1,1)},{3,(1,2)},{4,(2,1)},{5,(1,2)},{6,(1,2)},
                {7,(2,1)},{8,(1,2)},{9,(1,1)},{10,(2,1)},{11,(2,1)},{12,(2,1)},
                {13,(3,1)},{14,(1,2)},{15,(1,2)},{16,(3,0)},{17,(2,1)},{18,(0,3)},
                {19,(2,1)},{20,(1,2)},{21,(2,1)},{22,(1,2)},{23,(1,2)},{24,(1,2)},
                {25,(3,0)},{26,(1,2)},{27,(2,1)},{28,(2,1)},{29,(0,2)},{30,(0,2)},
                {31,(2,1)},{32,(2,1)},{33,(1,2)},{34,(1,2)},{35,(1,2)},{36,(0,2)},
                {37,(2,1)},{38,(2,0)},{39,(2,1)},{40,(0,2)},{41,(0,2)},{42,(2,1)},
                {43,(2,0)},{44,(1,2)},{45,(2,1)},{46,(2,1)},{47,(1,2)},{48,(0,2)},
                {49,(2,1)},{50,(0,2)},{51,(2,1)},{52,(1,2)},{53,(1,2)},{54,(0,2)},
                {55,(2,1)},{56,(1,2)},{57,(2,1)},{58,(0,2)},{59,(0,3)},{60,(1,2)},
                {61,(2,0)},{62,(1,2)},{63,(2,0)},{64,(2,1)},{65,(0,2)},{66,(0,3)},
                {67,(2,1)},{68,(2,1)},{69,(2,1)},{70,(1,2)},{71,(0,2)},{72,(1,2)},
            },
            ["Jonas"] = new() {
                {1,(2,0)},{2,(1,1)},{3,(1,0)},{4,(2,1)},{5,(1,2)},{6,(1,2)},
                {7,(2,1)},{8,(0,2)},{9,(1,0)},{10,(2,1)},{11,(2,1)},{12,(2,1)},
                {13,(2,0)},{14,(1,1)},{15,(1,2)},{16,(3,0)},{17,(2,1)},{18,(0,2)},
                {19,(2,0)},{20,(1,2)},{21,(2,1)},{22,(1,2)},{23,(1,2)},{24,(1,2)},
                {25,(3,0)},{26,(1,2)},{27,(2,1)},{28,(2,0)},{29,(0,2)},{30,(0,1)},
                {31,(2,1)},{32,(2,1)},{33,(1,2)},{34,(1,1)},{35,(1,2)},{36,(0,2)},
                {37,(2,1)},{38,(2,0)},{39,(2,1)},{40,(0,2)},{41,(0,2)},{42,(2,1)},
                {43,(2,0)},{44,(1,2)},{45,(2,1)},{46,(2,0)},{47,(1,2)},{48,(0,2)},
                {49,(2,0)},{50,(0,2)},{51,(2,0)},{52,(1,2)},{53,(1,2)},{54,(0,2)},
                {55,(2,0)},{56,(1,2)},{57,(2,0)},{58,(1,2)},{59,(0,2)},{60,(1,2)},
                {61,(2,0)},{62,(1,2)},{63,(2,0)},{64,(2,1)},{65,(1,2)},{66,(0,2)},
                {67,(2,0)},{68,(2,1)},{69,(2,0)},{70,(1,2)},{71,(0,2)},{72,(1,2)},
            },
            ["Tim"] = new() {
                {1,(2,0)},{2,(1,1)},{3,(1,2)},{4,(2,1)},{5,(1,2)},{6,(1,2)},
                {7,(2,1)},{8,(0,2)},{9,(1,1)},{10,(2,1)},{11,(1,2)},{12,(2,1)},
                {13,(2,0)},{14,(1,2)},{15,(1,2)},{16,(3,0)},{17,(2,1)},{18,(0,3)},
                {19,(2,1)},{20,(1,2)},{21,(2,1)},{22,(1,2)},{23,(1,2)},{24,(1,2)},
                {25,(3,0)},{26,(1,2)},{27,(2,1)},{28,(2,1)},{29,(1,2)},{30,(0,2)},
                {31,(2,1)},{32,(2,1)},{33,(1,2)},{34,(1,2)},{35,(2,1)},{36,(0,2)},
                {37,(2,1)},{38,(2,0)},{39,(2,1)},{40,(0,2)},{41,(0,2)},{42,(2,1)},
                {43,(2,0)},{44,(1,2)},{45,(2,1)},{46,(2,1)},{47,(1,2)},{48,(0,2)},
                {49,(2,1)},{50,(0,2)},{51,(2,1)},{52,(1,2)},{53,(1,2)},{54,(0,2)},
                {55,(2,0)},{56,(1,2)},{57,(2,1)},{58,(1,2)},{59,(0,3)},{60,(1,2)},
                {61,(2,0)},{62,(1,2)},{63,(2,0)},{64,(2,1)},{65,(0,2)},{66,(0,3)},
                {67,(2,1)},{68,(2,1)},{69,(2,1)},{70,(1,2)},{72,(1,2)},
            },
            ["Kalle"] = new() {
                {1,(3,1)},{2,(1,1)},{3,(2,0)},{4,(2,1)},{5,(1,2)},{6,(2,1)},
                {7,(2,1)},{8,(1,2)},{9,(2,1)},{10,(2,1)},{11,(2,1)},{12,(2,1)},
                {13,(3,0)},{14,(1,2)},{15,(1,2)},{16,(3,0)},{17,(2,1)},{18,(0,3)},
                {19,(2,1)},{20,(1,2)},{21,(2,1)},{22,(1,2)},{23,(1,2)},{24,(2,1)},
                {25,(3,0)},{26,(2,1)},{27,(2,1)},{28,(2,1)},{29,(1,2)},{30,(1,2)},
                {31,(2,1)},{32,(2,1)},{33,(1,2)},{34,(1,2)},{35,(1,2)},{36,(1,2)},
                {37,(2,1)},{38,(2,0)},{39,(2,1)},{40,(1,2)},{41,(0,2)},{42,(2,1)},
                {43,(2,0)},{44,(1,2)},{45,(2,1)},{46,(2,1)},{47,(1,2)},{48,(1,2)},
                {49,(2,1)},{50,(1,2)},{51,(2,1)},{52,(1,2)},{53,(1,2)},{54,(0,2)},
                {55,(2,1)},{56,(1,2)},{57,(2,1)},{58,(1,2)},{59,(0,3)},{60,(1,2)},
                {61,(2,0)},{62,(1,2)},{63,(2,0)},{64,(2,1)},{65,(1,2)},{66,(0,2)},
                {67,(2,1)},{68,(2,1)},{69,(2,1)},{70,(1,2)},{71,(0,2)},{72,(2,1)},
            },
        };
        // Martin HJ tips same as Familjen
        hjTips["Martin"] = familjenTips["Martin"];

        var tips = new List<Tip>();
        // Familjen tips
        foreach (var (uname, userTips) in familjenTips)
        {
            var u = U(uname);
            foreach (var (matchId, (h, a)) in userTips)
                tips.Add(new Tip { UserId = u.Id, MatchId = matchId, HomeGoals = h, AwayGoals = a });
        }
        // HJ tips (Martin already has tips, skip duplicates)
        foreach (var (uname, userTips) in hjTips)
        {
            if (uname == "Martin") continue; // already added
            var u = U(uname);
            foreach (var (matchId, (h, a)) in userTips)
                tips.Add(new Tip { UserId = u.Id, MatchId = matchId, HomeGoals = h, AwayGoals = a });
        }
        ...
        var sidoData = new Dictionary<string,(string? sky, string? ast, string? gul)>
        {
            ...
            // HJ
            ["Sebnastian"]= ("Harry kane",       "dembele",         "Rudiger"),
            ["Jonas"]     = ("Mbappe",           "Bruno Fernandes", "Casemiro"),
            ["Tim"]       = ("Mbappe",           "Musiala",         "Rice"),
            ["Kalle"]     = ("Lautaro Martinez", "Raphinha",        "Gravenberch"),
        };
        ...
        {
            var u = U(uname);
            sidoTips.Add(new SidoTip { UserId = u.Id, Skyttekung = sky, Assistkung = ast, GultKort = gul });
        }
