...
public static class MatchTimeService
{
    ...
    private static readonly Dictionary<int, DateTime> _kickoffs = new()
    {
        ...
        {83, Utc("2026-07-11",21,00)},  // 23:00 sv
        {84, Utc("2026-07-12",01,00)},  // 03:00 sv
        // Åttondelsfinaler (R16) – DB-id 73-80. Svensk tid -2h = UTC.
        {73, Utc("2026-07-04",17,00)},  // 19:00 sv
        {74, Utc("2026-07-04",21,00)},  // 23:00 sv
        {75, Utc("2026-07-05",20,00)},  // 22:00 sv
        {76, Utc("2026-07-06",00,00)},  // 02:00 sv
        {77, Utc("2026-07-06",19,00)},  // 21:00 sv
        {78, Utc("2026-07-07",00,00)},  // 02:00 sv
        {79, Utc("2026-07-07",16,00)},  // 18:00 sv
        {80, Utc("2026-07-07",20,00)},  // 22:00 sv
