// FIFA World Cup 2026 Annex C - Official third place bracket combinations
// Key = 8 groups sorted alphabetically (e.g. "ACDEFGHI")
// Value = which third-place team (3X) faces each group winner slot
// Columns: 1A vs, 1B vs, 1D vs, 1E vs, 1G vs, 1I vs, 1K vs, 1L vs
export const FIFA_ANNEX_C = {
