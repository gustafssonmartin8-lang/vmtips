...
import { Trophy, Calendar, Users, Star, ShieldCheck, LogOut, ChevronDown, BarChart2, Award, Menu, X, Grid3x3, GitBranch } from 'lucide-react'
...
export default function Layout() {
  ...
  const links = [
    ...
    { to: '/achievements',label: 'M�rken',     icon: Award },
